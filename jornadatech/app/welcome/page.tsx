...
import { UserRound, Target, Route, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-xl text-center">
      <h1 className="font-[family-name:var(--font-display)] text-[32px] leading-[1.15] tracking-tight text-[#16231C] md:text-[40px] mt-10">
        Vamos montar seu Canvas de Carreira
      </h1>
      <p className="mx-auto mt-4 max-w-md text-[16px] leading-relaxed text-[#4B5B52]">
        Em poucos minutos você vai contar um pouco sobre você, avaliar suas
        competências de hoje e sair daqui com um plano priorizado do que
